        ...
        <div className='height'>
            <div className='contactDiv'>
                <div className='contactGreeting'>
                    ...
                    <Link to='https://facebook.com/abcatering028072' target="_blank" rel="noopener noreferrer"><img className='iconssmall' src={fb}/></Link>
                    <Link to='https://instagram.com/abcatering028072' target="_blank" rel="noopener noreferrer"><img className='iconssmall'src={insta}/></Link>
                    <br/>
